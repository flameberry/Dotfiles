...
themes["rose-pine"] = {
	...
	config = {
		...
		highlight_groups = {
			...
			NormalFloat = { bg = "NONE" }, -- Transparent floating windows (Telescope, Lazy)
			FloatBorder = { fg = "highlight_med", bg = "NONE" }, -- Transparent border
			Pmenu = { bg = "base" }, -- Opaque completion menu background
			PmenuSel = { bg = "overlay" }, -- Opaque selected item in completion menu
