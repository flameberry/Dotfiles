...
-- Assembly dialects: .asm = NASM (Intel syntax, x86-64), .s/.S = GNU as (arm64)
vim.filetype.add({
  extension = {
    asm = "nasm",
    nasm = "nasm",
...
-- Route the nvim-treesitter `asm` parser at NASM buffers too
vim.treesitter.language.register("asm", { "nasm", "masm" })
